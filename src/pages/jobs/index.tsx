...
export function JobListPage(props: JobListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getJobs({
        relations: ['employer', 'candidate.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('employer', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'employer',
          header: 'Employer',
          accessorKey: 'employer',
          cell: ({ row: { original: record } }: any) => (
            <Link as={NextLink} onClick={(e) => e.stopPropagation()} href={`/employers/view/${record.employer?.id}`}>
